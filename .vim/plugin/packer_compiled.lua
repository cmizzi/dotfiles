...
_G.packer_plugins = {
  ...
  ["lspkind-nvim"] = {
    loaded = true,
    path = "/home/cyril/.local/share/nvim/site/pack/packer/start/lspkind-nvim",
  ...
  ["nvim-colorizer.lua"] = {
    ...
    loaded = true,
    path = "/home/cyril/.local/share/nvim/site/pack/packer/start/nvim-colorizer.lua",
